    ...
    <div class="w3l-grids-block-5 py-5">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                <h3 class="title-style">Academics Overview</h3>
                <p>Adarsh Public School excels in teaching critical thinking, complex
                    problem solving, and higher order reasoning. Studies indicate a clear link between these skills and
                    eventual success in college and in the workplace. This directs all elements of the A.P.S.
                    Academic Compass.</p>
            </div>
